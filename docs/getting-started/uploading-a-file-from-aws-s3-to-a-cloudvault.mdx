...
- An S3 connection object in `s3_connector`
    ...
    - The prefix for files under `prefix`
...
After you have the connector, you will need an `Import` task to execute the import. Your `import` config will connect your `import-connector-config` to your Cloud Vault.
