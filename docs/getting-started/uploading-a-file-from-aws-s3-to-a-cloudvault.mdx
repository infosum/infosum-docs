...
Before you can import files from AWS, you will need to set up your AWS cross account bucket so InfoSum can access it. To do this, follow the steps in [configuring AWS S3 cross-account](https://support.infosum.com/hc/en-us/articles/4404419516049), replacing the "principal" and "external_id" values with the ones returned by Get ICC.
