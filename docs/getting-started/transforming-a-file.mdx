...
The following bloblang script does this. By declaring the `input` file and how to read it, the `bloblang` itself is a transformation pipeline, and the `output` for the format to return to the Cloud Vault.
