...
If no files have been uploaded to the [File Vault](../filevaults), please refer to the [uploading a file getting started guide](./uploading-a-file-to-a-filevault).
