...
If no files have been uploaded to the [File Vault](../filevaults), please refer to the getting started guides for [uploading a file from AWS S3](./uploading-a-file-from-aws-s3-to-a-filevault).
