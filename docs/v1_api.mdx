...
You must provide either your v1 API public-private keypair in the authorization header for all API requests to `/api/v1` paths in the format `<public_token>/<private_token>`.
Alternatively can use a v2 API token in the authorization header in the format format '<token>'.
</Admonition>
