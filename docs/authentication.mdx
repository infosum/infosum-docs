...
The InfoSum APIs require an [`API Key`](https://support.infosum.com/hc/en-us/articles/360019074958-API-key) that is used as part of the `Authorization` header.
...
Once you have created an InfoSum account and have the [relevant permissions](https://support.infosum.com/hc/en-us/articles/360019049798-Permissions-overview). Use the following steps to generate an API key:
